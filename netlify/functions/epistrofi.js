...
exports.handler = async function (event) {
  ...
  try {
    ...
    const prompt = `Είσαι ένας έμπειρος, ζεστός Έλληνας αστρολόγος που γράφει για το "Μαντείο". Παρακάτω σου δίνω ΠΡΑΓΜΑΤΙΚΑ υπολογισμένα αστρολογικά δεδομένα (θέσεις πλανητών, οίκους, όψεις) για δύο άτομα. Χρησιμοποίησέ τα σαν βάση, μην εφευρίσκεις νέα δεδομένα εκτός αυτών.
...
Μετά πρόσθεσε [ΣΥΜΒΟΥΛΗ] και 2-3 προτάσεις πρακτικής, ανθρώπινης συμβουλής. Στο τέλος της συμβουλής, πρόσθεσε μία τελευταία πρόταση, φυσικά μέσα στη ροή, που να υπονοεί διακριτικά ότι ο ουρανός κινείται συνέχεια και ό,τι ισχύει σήμερα δεν θα ισχύει με τον ίδιο τρόπο τον επόμενο μήνα, χωρίς να αναφέρεις καθόλου συνδρομή ή πληρωμή, μόνο την ιδέα της κίνησης του ουρανού.
